## step 1
# read all the data
test.labels <- read.table("UCIHARDataset/test/y_test.txt", col.names="label")
test.subjects <- read.table("UCIHARDataset/test/subject_test.txt", col.names="subject")
test.data <- read.table("UCIHARDataset/test/X_test.txt")
train.labels <- read.table("UCIHARDataset/train/y_train.txt", col.names="label")
train.subjects <- read.table("UCIHARDataset/train/subject_train.txt", col.names="subject")
